...
app.post("/generate-pdf", async (req, res) => {
  ...
  <body>
    ...
    formData.apartmentNum === 2 ? "checked" : ""
                      ...
                      <label for="main">Hauptwohnung</label>
                    </div>
                    <div class="bfsc__checkbox">
    ...
    formData.apartmentNum === 3 ? "checked" : ""
                      ...
                      <label for="secondary">Nebenwohnung</label>
                    </div>
                  </div>
              ...
              <tbody>
                <tr>
                  <td style="border-top: 0;
                      border-bottom: 0;font-size: small;">${formData.co ? "bei" : ""} ${formData.co}</td>
                  <td style="border-top: 0;
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="border-bottom: 0; font-size: small;">
                  ...
                  ${people.secondNationality ? people.secondNationality : ""}
                </td>
              </tr>
              <tr>
          ...
          if (index == formData.people.length - 1) {
            ...
            <tbody>
              ...
              <tr>
                ...
                <td style="border-bottom: 0; font-size: small;">
                  ${people.birthDate}${people.birthPlace ? "," : ""} 
                  ${people.birthPlace}${ people.birthCountry ? "," : "" } 
                  ${ people.birthCountry }
                </td>
              </tr>
              <tr>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="border-bottom: 0; font-size: small;">
                    ...
                    ${
                      formData.people[index + 1].secondNationality ? formData.people[index + 1].secondNationality : ""
                    }
                  </td>
                </tr>
                <tr>
          ...
          <div class="bs__third_table">
            <table class="table-container">
              ...
              <tbody>
                <tr>
                  <td style="border-right: 0; font-size: small;">${formData.marital}</td>
                  <td style="font-size: small;">${formData.marriedFrom ? formData.marriedFrom : ''}${formData.marriagePlace ? "," : ""}
                    ${formData.marriagePlace ? formData.marriagePlace : ''}${formData.marriageCountry ? "," : ""} ${formData.marriageCountry ? formData.marriageCountry : ''}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="bt__snd_table">
              ...
              <tbody>
                <tr>
                  ...
                  <td style="border-right: 0; font-size: small;">${formData.people[index + 1] ? formData.people[index + 1].authorityName : ''}${formData.people[index + 1] ? ',' : ''} ${formData.people[index + 1] ? formData.people[index + 1].placeName : ''}</td>
